...
# Run bankroll updater each cron (right after settlement)
...
# enrich_fixture may or may not exist in your branch—wrap it safely
try:
...
from utils.get_prediction import get_prediction  # <- your working prediction engine
...
if __name__ == "__main__":
    ...
    # --- 3) Then compute NEW predictions -------------------------------------
    if argv_ids:
